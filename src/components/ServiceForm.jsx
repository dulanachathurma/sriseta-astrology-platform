...
📜 කරුණාකර ඔබගේ ජන්මපත්‍රයේ පැහැදිලි ඡායාරූපයක් (Photos) මේ සමඟ යොමු කරන්න.
...
🙏 ස්තුතියි !`;
  ...
  if (submitted) {
    return (
      <motion.div
        ...
        className="text-center py-4 pt-16"
      >
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 pt-16 md:pt-20">
      <div>
